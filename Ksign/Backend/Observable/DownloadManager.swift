...
class Download: Identifiable, @unchecked Sendable, ObservableObject {
    ...
    var resumeData: Data?
        ...
        /// Source repository URL for update tracking
        let sourceURL: URL?
...
class DownloadManager: NSObject, ObservableObject {
    ...
    func startDownload(
        ...
        print(id)
                let download = Download(id: id, url: url, sourceURL: sourceURL)
        ...
        func startArchive(
                ...
                let download = Download(id: id, url: url, onlyArchiving: true, sourceURL: sourceURL)
                downloads.append(download)
                _updateBackgroundAudioState()
                return download
        }
